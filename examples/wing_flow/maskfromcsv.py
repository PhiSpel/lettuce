...
def mask_from_csv(x, y, wing_name, n_wing_nose, n_wing_tail, wing_length_x):
    nx1, ny1 = np.shape(x)
    ...
    scaling_factor = wing_length_x / actual_wing_length_x
    ...
    x_data_interp = np.linspace(0, wing_length_x, available_length_n)  # [0 ... 5.05]
